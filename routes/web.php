...
Route::group( [
        ...
        // Route::get('/','AdminController@index')->name('student.index');
        // Route::get('/profile','AdminController@profile')->name('student.profile');
        // Route::get('settings','AdminController@settings')->name('student.settings');
});

// user management
Route::group( [
    'prefix'=>'user',
    'middleware'=>['auth','check_user_is_active'],
    'namespace'=>'Admin'
],function(){
